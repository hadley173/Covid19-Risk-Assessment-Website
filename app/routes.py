...
def formInput():
	...
	if form.validate_on_submit():
		...
		risk_rating, state_score, stateList, low_risk_events, mod_risk_events, mod_high_risk_events, high_risk_events, icuCurrently, hospCurrently, index, sorted_pos_total, sorted_pos_total_inc, stateGrade, all_states_pos, all_states_pos_inc = getData()
		
		#pos1 = jsonify(all_states_pos)
		#pos_inc1 = jsonify(all_states_pos_inc)
		#print("routes.py pos: ", all_states_pos)
		#print("routes.py pos_inc: ", all_states_pos_inc)
		#print("pos routes.py", pos1)
		#print("posinc routes.py", pos_inc1)
		# CHART.JS example line chart test
		#legend = 'Monthly Data'
		#labels = ['January', 'February', 'March', 'April', 'May', 'June', 'July']
		#values = [10, 9, 8, 7, 6, 4, 8]

		#return render_template('results.html', title='Risk score', userData=userData, state_score=state_score, risk_rating=risk_rating, low_risk_events=low_risk_events, mod_risk_events=mod_risk_events, mod_high_risk_events=mod_high_risk_events, 
		...
		return render_template('results.html', title='Risk score', userData=userData, state_score=state_score, risk_rating=risk_rating, low_risk_events=low_risk_events, mod_risk_events=mod_risk_events, mod_high_risk_events=mod_high_risk_events, 
		high_risk_events=high_risk_events, stateList=stateList, icuCurrently=icuCurrently, hospCurrently=hospCurrently, index=index, sorted_pos_total=sorted_pos_total, sorted_pos_total_inc=sorted_pos_total_inc, stateGrade=stateGrade, all_states_pos=all_states_pos, all_states_pos_inc=all_states_pos_inc)
